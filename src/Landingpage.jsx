      ...
      <div className="navcontainer">
        <div className="landing_header">
          ...
          <div className="login-btn">
            <Link className="otsNavLinks eAnimation" to={"/"}>
        ...
        <div className="logoo">
          <img src={logoo} className="logoo" alt="" />
        </div>
        ...
        <div className="row">
          <div className="col1">
            ...
            <p>
              ...
              developed by the alumni of IIT/IISc with an intent to enhance the
              student's abilities to face some of the toughest exams of the
