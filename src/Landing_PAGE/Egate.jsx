...
import logo from './EgateLogo.png'
              ...
              <div>
                ...
                <ul className='EGATE_elandUl'>
                  ...
                  <Link className='EGATE_elanLink' to={"/home"}>
                    <h3 className='Pg_buttonn'><span class="text">UG</span> </h3>
                  </Link>
            ...
            <div className='Ug_egatePAge-pg '>
              ...
              <ul className='EGATE_elandUl'>
                ...
                <Link className='EGATE_elanLink' to={"/PgHome"}>
                  <h3 className='Pg_buttonn'><span class="text">PG</span> </h3>
                </Link>
                ...
                <li><Link to={'/pgEse_exam'} >ESC</Link></li>
