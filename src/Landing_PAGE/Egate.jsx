          ...
          <div className="EGATE_eCordsLanding ">
              ...
              <div>
                ...
                <ul className="EGATE_elandUl">
                  ...
                  <ul className="EGATE_elandUl">
                    ...
                    to={`/home/${item.section_id}`}
                    onClick={() => window.scrollTo(0, 0)}
                  >

                    <h3 className="Pg_buttonn">
                      <span className="text">UG COURSES</span>
                    </h3>
                  </Link>
                    <li>
                      <Link to="/iitjeeExam">
                        IIT-JEE <span> (Mains & Advanced) </span>{" "}
                      </Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <HashLink to="/home#exam" element={<Exam_Explore />}>
            ...
            <div className="Ug_egatePAge-pg ">
              ...
              <ul className="EGATE_elandUl">
                ...
                >
                  <h3 className="Pg_buttonn">
                    <span class="text">PG COURSES</span>{" "}
                  </h3>
                </Link>
                ...
                <li>
                  <Link to={"/pggateexam"}>GATE</Link>
                </li>
                <li>
                  <Link to={"/pgiitjamexam"}>IIT-JAM</Link>
                </li>
                <li>
                  <Link to={"/pgEse_exam"}>ESE</Link>
                </li>
                <li>
                  <Link to={"/isro_examPage"}>ISRO</Link>
                </li>
                <li>
                  <HashLink to={"/PgHome#Exams"} element={<Pg_exploreExam />}>
                    &OTHER ENTRANCE EXAMS
                  </HashLink>
                </li>
              </ul>
