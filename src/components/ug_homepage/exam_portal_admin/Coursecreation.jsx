...
const Coursecreation = () => {
    ...
    const fetchSelectedExam = async () => {
      try {
        const response = await fetch(
          `http://localhost:5001/courese-exams/${selectedexams}`
        );
  ...
  useEffect(() => {
    const fetchCourseData = async () => {
      try {
        const response = await fetch(
          "http://localhost:5001/course_creation_table"
        );
  ...
  useEffect(() => {
    fetch("http://localhost:5001/courese-exams")
  ...
  const handleexams = async (event) => {
    ...
    try {
      const response = await fetch(
        `http://localhost:5001/courese-exam-subjects/${selectedExamId}/subjects`
      );
      const data = await response.json();
  ...
  useEffect(() => {
    const fetchTypeOfTest = async () => {
      try {
        const response = await fetch("http://localhost:5001/type_of_tests");
        const result = await response.json();
  ...
  useEffect(() => {
    const fetchTypeOfQuestion = async () => {
      try {
        const response = await fetch("http://localhost:5001/type_of_questions");
        const result = await response.json();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("http://localhost:5001/course-creation", {
        method: "POST",
        headers: {
  ...
  const handleDelete = async (courseCreationId) => {
    ...
    if (confirmDelete) {
      try {
        const response = await fetch(
          `http://localhost:5001/course_creation_table_Delete/${courseCreationId}`,
          {
            method: "DELETE",
          }
        );
