...
const StudentRegistrationPage = () => {
    ...
    const fetchbatch = async () => {
      try {
        const response = await axios.get(
          "http://localhost:5001/StudentRegistationPage/batch"
  ...
  useEffect(() => {
    const fetchQualifications = async () => {
      try {
        const response = await axios.get(
          "http://localhost:5001/StudentRegistationPage/Qualifications"
        ); // Adjust the endpoint URL based on your backend setup
        setQualifications(response.data);
      } catch (error) {
        console.error("Error fetching states:", error);
  ...
  const handleDisplayData = (e) => {
    ...
    const missingFieldsList = Object.keys(formData).filter(
      (key) => formData[key] === "" && formRef.current[key]?.hasAttribute("required")
    );
    ...
    <div className="srp-container">
      <form ref={formRef} onSubmit={handleFormSubmit}>
          ...
          <div className="content_reg">
            <div className="inputContent">
              <label htmlFor="candidateName"  >
                CANDIDATE NAME(accoding to 10th memo):
              </label>
              <input
                type="text"
                id="candidateName"
            ...
            <div className={`inputContent ${missingFields.includes("GenderId") ? "missing-field" : ""}`}>
              <label>GENDER:</label>
              {genders.map((gender) => (
                <div key={gender.GenderId}>
                  <input
            ...
            {/* CATEGORY: */}
            <div className={`inputContent ${missingFields.includes("CategoryId") ? "missing-field" : ""}`}>
              <label>CATEGORY:</label>
              {categories.map((category) => (
                <div key={category.CategoryId}>
                  <input
            ...
            <div className={`inputContent ${missingFields.includes("emailId") ? "missing-field" : ""}`}>
              <label htmlFor="emailId">EMAIL ID:</label>
              <input
            ...
            <div className={`inputContent ${missingFields.includes("confirmEmailId") ? "missing-field" : ""}`}>
              <label htmlFor="confirmEmailId">CONFIRM EMAIL ID:</label>
              <input
                className="inputContent_input"
                type="email"
            ...
            <div className={`inputContent ${missingFields.includes("contactNo") ? "missing-field" : ""}`}>
              <label htmlFor="contactNo">CONTACT NO:</label>
              <input
                type="number"
                id="contactNo"
        ...
        <section>
          <h2 className="srp_heading">FATHER'S/GUARDIAN'S DETAILS</h2>
          <div className="content_reg">
            <div className={`inputContent ${missingFields.includes("fatherName") ? "missing-field" : ""}`}>
              <label htmlFor="fatherName">FATHER'S NAME:</label>
              <input
                type="text"
                id="fatherName"
            ...
            <div className={`inputContent ${missingFields.includes("occupation") ? "missing-field" : ""}`}>
              <label htmlFor="occupation">OCCUPATION:</label>
              <input
                type="text"
                id="occupation"
            ...
            <div className={`inputContent ${missingFields.includes("mobileNo") ? "missing-field" : ""}`}>
              <label htmlFor="mobileNo">MOBILE NO:</label>
              <input
                type="number"
                id="mobileNo"
        ...
        <section>
          <h2 className="srp_heading">COMMUNICATION ADDRESS</h2>
          <div className="content_reg">
            <div className={`inputContent ${missingFields.includes("line1") ? "missing-field" : ""}`}>
              <label htmlFor="line1">LINE1:</label>
              <input
            ...
            <div className={`inputContent ${missingFields.includes("state_id") ? "missing-field" : ""}`}>
              <h2>SELECT A STATE:</h2>
            ...
            <div>
              {selectedState && (
                <div className={`inputContent ${missingFields.includes("districts_id") ? "missing-field" : ""}`}>
                  <h2>SELECT A DISTRICT:</h2>
                  <select
                    onChange={handledistrictChange}
                    value={selecteddistrict} required
                  >
                    <option value="" disabled>
                      Choose a district
                    </option>
            ...
            <div className={`inputContent ${missingFields.includes("pincode") ? "missing-field" : ""}`}>
              <label htmlFor="pincode">PINCODE:</label>
              <input
                type="number"
                id="pincode"
        ...
        <section>
          ...
          <div className="content_reg">
            ...
            <div className={`inputContent ${missingFields.includes("BatchId") ? "missing-field" : ""}`}>
              <h2>BATCH</h2>
              <select onChange={handleBatchChange} value={selectedBatch} required>
                <option value="" disabled>
                  Choose a Batch
                </option>
                {Batchs.map((Batch) => (
        ...
        <section>
          <h2 className="srp_heading">EDUCATION DETAILS</h2>
          <div className="content_reg">
            <div className={`inputContent ${missingFields.includes("edStatusId") ? "missing-field" : ""}`}>
              <h2>QUALIFICATION:</h2>
              <select
                onChange={handleQualificationChange}
                value={selectedQualification} required
              >
                <option value="" disabled>
                  Choose a Qualification
                </option>
            ...
            <div className={`inputContent ${missingFields.includes("NameOfCollege") ? "missing-field" : ""}`}>
            ...
            <div className={`inputContent ${missingFields.includes("passingYear") ? "missing-field" : ""}`}>
              <label htmlFor="passingYear"   >PASSING YEAR:</label>
              <input
                type="text"
                id="passingYear"
            ...
            <div className={`inputContent ${missingFields.includes("marks") ? "missing-field" : ""}`}>
              <label htmlFor="marks">MARKS IN %:</label>
              <input
                type="text"
                id="marks"
        ...
        <section>
          ...
          <div className="content_reg">
            ...
            <div className="imgSection">
              ...
              <img src={noimg} width={144} height={144} alt="asaS" />
              <div className="input-filde">
                <input type="file" name="filess" onChange={handleFileChange} />
                {/* <span className="errorText">{formErrors.filess}</span> */}
              </div>
            </div>
            {/* UPLOAD ID PROOF   -----------*/}
            <div className="imgSection">
              ...
              <img src={noimg} width={144} height={144} alt="asaS" />
              <div className="input-filde">
                <input type="file" name="filess3" onChange={handleFileChange} />
                {/* <span className="errorText">{formErrors.filess3}</span> */}
              </div>
            </div>
          </div>
