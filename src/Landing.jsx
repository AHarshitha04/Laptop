      ...
      <section className="eLanding_Container">
        <div className="landingE">
          ...
          <p>
            ...
            virtually to every corner of the country. Our courses are developed
            by the alumni of IIT/IISc with an intent to enhance the student's
        ...
        <div className="eCordsLanding">
          <Link className="elanLink" to={"/home"}>
            <ul className="elandUl">
              ...
              <li>
                <Link>&OTHER ENTRANCE EXAMS</Link>
              </li>
            </ul>
          </Link>
          ...
          <Link className="elanLink">
            <ul className="elandUl">
              ...
              <li>
                <Link>MERCANTILE LAWS</Link>
              </li>
              <li>
                <Link>GENERAL ECONOMICS</Link>
              </li>
              <li>
                <Link>QUANTITATIVE APTITUDE</Link>
              </li>
              <li>
                <Link>&OTHER ENTRANCE EXAMS</Link>
              </li>
